...
public class Path {
    ...
    public static class Web {
        ...
        @Getter public static final String INFO = "/info/";
    ...
    public static class Template {
        ...
        public final static String INFO = "/velocity/info/information.vm";
        public final static String SEARCH = "/velocity/search/search.vm";
